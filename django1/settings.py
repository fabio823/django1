...
SECRET_KEY = 'django-insecure-o@_vkhu)_4#hb739yopj9gw=#^n9pbi+a=w6u3gbtm_z-4h@41'

# SECURITY WARNING: don't run with debug turned on in production!
# DEBUG com valor True esta em desenvolvimento
# DEBUG caom valor False esta em producao
DEBUG = False
